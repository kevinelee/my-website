  ...
  return (
    <div className="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <div className="mt-8 flex justify-center">
        <a href="https://www.linkedin.com/in/kevinelee/" className="text-gray-400 hover:text-gray-200">
        ...
        <a href="./Resume 092020.pdf" className="ml-6 text-gray-400 hover:text-gray-200">
